...
const NavigatePages = ({ posters, numOfPosters, sorted, genre }) => {
      ...
      <div className="page-nav">
        <ul>
          <li className="prev-page">
            <span onClick={prevPage}>&lsaquo;</span>
          </li>
          <li>
            <span>...</span>
          </li>
          ...
          <li>
            <span onClick={handlePage}>2</span>
          </li>
          <li>
            <span onClick={handlePage}>3</span>
          </li>
          <li>
            <span onClick={handlePage}>4</span>
          </li>
          <li>
            <span onClick={handlePage}>5</span>
          </li>
          <li>
            <span>...</span>
          </li>
          <li className="next-page">
            <span onClick={nextPage}>&rsaquo;</span>
          </li>
        </ul>
      </div>
    </>
